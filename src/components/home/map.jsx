...
const Map = () => {
  ...
  const dark = "https://api.maptiler.com/maps/streets-v2-dark/256/{z}/{x}/{y}.png?key=kHLg8AiFGgnch1FMqKRv";
  ...
  const { formLocationData, mapStyle, setMapStyle ,pos ,setPos } = useContext(globalContext);
